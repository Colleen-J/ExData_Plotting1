## Data Science - Exploratory Data Analysis, week 4 project, Plot 1
...
png(file="C:/Users/wacja/Documents/Colleen work/Data science coursera/plot1.png",width = 480, height = 480, unit = "px")
hist(pwdf$Global_active_power,col=10,main="Global Active Power",xlab="Global Active Power (kilowatt)")
dev.off()
