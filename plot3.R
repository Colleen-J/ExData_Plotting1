## Data Science - Exploratory Data Analysis, week 4 project, Plot 3
...
png(file="C:/Users/wacja/Documents/Colleen work/Data science coursera/plot3.png",width = 480, height = 480, unit = "px")
...
legend('topright', legend=names(pwdf)[-1][4:6], lty=1,col=c('black', 'red', 'blue'))
dev.off()
